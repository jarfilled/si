...
class _LoginPageState extends State<LoginPage> {
  ...
  InputDecoration _inputDecoration({required String label, required IconData icon}) => InputDecoration(
        labelText: label,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(colors: [mint, Color(0xFFEAF8FC)], begin: Alignment.topRight, end: Alignment.bottomLeft),
                      ...
                      child: const Row(
                        children: [
                          ...
                          Icon(Icons.favorite_rounded, color: primaryGreen, size: 40),
                        ],
                      ),
                    ),
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: TextButton.icon(
                              ...
                              icon: _resettingPassword ? const SizedBox(width: 13, height: 13, child: CircularProgressIndicator(strokeWidth: 2, color: primaryGreen)) : const Icon(Icons.lock_reset_rounded, size: 17),
                              label: const Text('رمز عبور را فراموش کرده‌اید؟', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: primaryGreen)),
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: _isLoading ? const SizedBox(width: 22, height: 22, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Text('ورود به برنامه', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
                            ),
                          ),
                        ],
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(onPressed: () => Navigator.pushReplacementNamed(context, '/signup'), child: const Text('ثبت‌نام کنید', style: TextStyle(color: primaryGreen, fontWeight: FontWeight.w900))),
                      ],
                    ),
                  ],
                ),
