...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      final tourCompleted = await InitialTour.hasCompleted();
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      ...
      debugPrint('[Login] password reset failed: $error');
      debugPrintStack(stackTrace: stackTrace);
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'برای دیدن وضعیت امروزت وارد حساب شو.',
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                        color: subtext,
